              ...
              <div className="grid w-full gap-3 sm:grid-cols-[minmax(0,1fr)_230px] lg:w-auto">
                ...
                <div className="relative">
                  <select
                    ...
                    className="h-12 w-full appearance-none rounded-xl border border-amber-200 bg-white py-2 pl-4 pr-12 text-sm font-semibold text-amber-900 shadow-sm outline-none transition duration-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-200"
                  >
